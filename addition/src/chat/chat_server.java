...
public class chat_server extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        msg_text.setToolTipText("1'st Number");
        ...
        msg_area.setRows(5);
        msg_area.setToolTipText("Result");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(msg_send, javax.swing.GroupLayout.DEFAULT_SIZE, 218, Short.MAX_VALUE))
                .addGap(18, 18, 18)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            while(!msgin.equals("exit")){
                msgin=din.readUTF();
                msg_area.setText(msg_area.getText().trim()+"\nClient Result: "+msgin); // show the massage from get to the client
        }
